...
- For running tests on a K3S cluster with "etcd" datastore type, you should add the value "etcd" to the variable "datastore_type" , also you need have those variables at least empty:
```
- external_db       
- external_db_version
- instance_class  
